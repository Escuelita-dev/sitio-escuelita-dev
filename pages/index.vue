  ...
  <div>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 image-column">
              <div class="image-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                ...
                <figure class="image image-2"><img src="/images/resource/nino-programando-2.jpg" alt=""></figure>
              </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 content-column">
              <div class="content-box">
                ...
                <div class="bold-text" v-html="$md.render(acerca.Contenido)"></div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="our-teachers style-two sec-pad centred">
        ...
        <div class="container">
            ...
            <div class="row">                
                <div v-for="persona in personas" :key="persona.uid" class="col-xl-4 col-lg-6 col-md-12 block-column">
